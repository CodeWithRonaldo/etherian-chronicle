    ...
    <PageContainer>
      ...
      >
        <PageContainer.Grid columns={1}>
          <Card>
            <Card.Header>
              <h3 style={{ fontSize: 'var(--font-size-xl)', fontWeight: 'var(--font-weight-semibold)', textAlign: 'center' }}>
                Top Storytellers
              </h3>
            </Card.Header>
            <Card.Body>
                ...
                {topCommunityMembers.map((member, index) => (
                  <div 
                    ...
                    style={{ 
                      ...
                      gap: 'var(--space-3)',
                      padding: 'var(--space-4)',
                      backgroundColor: index === 0 ? 'var(--primary-50)' : index === 1 ? 'var(--secondary-50)' : index === 2 ? 'var(--accent-50)' : 'var(--bg-tertiary)',
                      borderRadius: 'var(--radius-lg)',
                      border: index < 3 ? '2px solid var(--primary-200)' : '1px solid var(--border-primary)',
                      position: 'relative'
                    }}
                  >
                    {index < 3 && (
                      <div style={{
                        ...
                        width: '32px',
                        height: '32px',
                        backgroundColor: index === 0 ? 'var(--warning-500)' : index === 1 ? 'var(--gray-400)' : 'var(--accent-600)',
                        borderRadius: '50%',
                        display: 'flex',
                        alignItems: 'center',
            ...
            <Card.Footer>
              <Button as={Link} to="/community" variant="ghost" size="small" fullWidth>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" style={{ marginRight: 'var(--space-2)' }}>
        ...
        <Card variant="filled">
          <Card.Body>
            <div style={{ textAlign: 'center', padding: 'var(--space-8) var(--space-4)' }}>
              ...
              <p style={{ fontSize: 'var(--font-size-lg)', color: 'var(--text-secondary)', marginBottom: 'var(--space-6)', maxWidth: '600px', margin: '0 auto var(--space-6)' }}>
                Join thousands of storytellers creating the future of interactive fiction. 
                Your choices matter, your voice counts, and your creativity earns rewards.
              </p>
              <div style={{ display: 'flex', gap: 'var(--space-4)', justifyContent: 'center', flexWrap: 'wrap' }}>
                <Button as={Link} to="/create" size="large">
                  Create Your First Story
                </Button>
                <Button as={Link} to="/proposals" variant="secondary" size="large">
                  Browse Proposals
                </Button>
              </div>
            </div>
