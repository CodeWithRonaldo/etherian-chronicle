...
const ProposalDetailPage = () => {
  ...
  const isUrgent = new Date(proposal.votingDeadline).getTime() - new Date().getTime() < 24 * 60 * 60 * 1000;
    ...
    <PageContainer>
      <div className={styles.container}>
        ...
        <nav className={styles.breadcrumb} aria-label="Breadcrumb">
          ...
          <Link to="/proposals" className={styles.breadcrumbLink}>Proposals</Link>
          <span className={styles.breadcrumbSeparator}>/</span>
        ...
        <header className={styles.header}>
          ...
          <div className={styles.titleSection}>
            <div className={styles.titleContent}>
              ...
              <div className={styles.creator}>
                ...
                <div className={styles.creatorInfo}>
                  <Link to={`/profile/${proposal.creator.id}`} className={styles.creatorName}>
            ...
            <div className={styles.statusSection}>
              {userVote && (
                <Badge variant={userVote === 'yes' ? 'success' : 'error'} size="large">
          ...
          <main className={styles.main}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.firstChapter}>
                <h3 className={styles.chapterTitle}>{proposal.firstChapter.title}</h3>
                <div className={styles.chapterContent}>
                  {proposal.firstChapter.content}
                </div>
                
                <div className={styles.chapterChoices}>
                  <h4 style={{ fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--text-primary)', marginBottom: 'var(--space-3)' }}>
                    Initial Choices:
                  </h4>
                  {proposal.firstChapter.choices.map((choice, index) => (
                    <div key={choice.id} className={styles.choice}>
                      <div className={styles.choiceLabel}>Option {index + 1}:</div>
                      {choice.text}
                    </div>
                  ))}
                </div>
            ...
            {!isVotingClosed && (
              <VotingInterface
                ...
                choices={[
                  { id: 'yes', text: 'Yes, approve this story proposal', votes: proposal.votes.yes },
                  { id: 'no', text: 'No, this proposal needs improvement', votes: proposal.votes.no }
                ]}
            ...
            {isVotingClosed && (
              <div className={styles.voteResults}>
                ...
                <p className={styles.voteResultsText}>
                  ...
                  {' '}by the community with {proposal.votes.yes} yes votes and {proposal.votes.no} no votes.
                  {voteOutcome === 'approved' && ' The story will now be available for collaborative development.'}
                  {voteOutcome === 'rejected' && ' The author can revise and resubmit the proposal.'}
                </p>
              </div>
            )}
          </main>
              ...
              <div className={styles.voteStats}>
                <div className={styles.voteStatsGrid}>
                  <div className={styles.voteStat}>
                    <div className={`${styles.voteStatValue} ${styles.voteStatValueYes}`}>
                      {proposal.votes.yes}
                    </div>
                  ...
                  <div className={styles.voteStat}>
                    <div className={`${styles.voteStatValue} ${styles.voteStatValueNo}`}>
                      {proposal.votes.no}
                    </div>
                  ...
                  <div className={styles.voteStat}>
                    <div className={`${styles.voteStatValue} ${styles.voteStatValueTotal}`}>
                      {totalVotes}
                    </div>
              ...
              <div className={styles.section}>
                ...
                <div className={`${styles.deadline} ${isUrgent ? styles.deadlineUrgent : ''}`}>
                  ...
                  <div className={styles.deadlineText}>
                    ...
                    <br />
                    <small>
                      Deadline: {new Date(proposal.votingDeadline).toLocaleDateString()} at{' '}
